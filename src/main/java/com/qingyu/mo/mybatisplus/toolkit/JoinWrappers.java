package com.qingyu.mo.mybatisplus.toolkit;

import com.baomidou.mybatisplus.core.conditions.segments.MergeSegments;
import com.qingyu.mo.mybatisplus.wrapper.query.JoinLambdaQueryWrapper;
import com.qingyu.mo.mybatisplus.wrapper.query.JoinLambdaUpdateWrapper;
...
public final class JoinWrappers {
    ...
    public static <T> JoinLambdaUpdateWrapper<T> lambdaUpdate() {
        return new JoinLambdaUpdateWrapper<>();
    }
     ...
     * @param <T>
     * @see com.qingyu.mo.mybatisplus.wrapper.query.JoinLambdaQueryWrapper
     */
