...
public interface JoinCompare<Children, R, T> extends Serializable {
     ...
     * @return children
     */
    default <J> Children jsonContain(R column, SFunction<J, ?> column2, Object... values) {
        return jsonContain(column, column2, Arrays.asList(values));
    }
     ...
     * @return children
     */
    default <J> Children jsonContain(R column, SFunction<J, ?> column2, Collection<?> coll) {
        return jsonContain(true, column, LambdaUtil.toPropertyName(column2), coll);
    }
     ...
     * @return children
     */
    <J> Children jsonContain(boolean condition, R column, String column2, Collection<?> coll);
