...
import com.qingyu.mo.mybatisplus.func.JoinCompare;
import com.qingyu.mo.mybatisplus.func.JoinFunc;
import com.qingyu.mo.mybatisplus.func.JoinMethod;
...
public abstract class AbstractJoinWrapper<T, Children extends AbstractJoinWrapper<T, Children>>
     ...
     */
    @Getter
    protected Boolean needCarrier = true;
    ...
    @Override
    public <J> Children jsonContain(boolean condition, SFunction<T, ?> column, String column2, Collection<?> coll) {
        return maybeDo(condition, () -> appendSqlSegments(columnToSqlSegment(ConstantPlus.JSON_CONTAIN,
                        column2 == null ? columnToString(column) : columnToString(column) + "->'$[*]." + column2 + StringPool.SINGLE_QUOTE),
