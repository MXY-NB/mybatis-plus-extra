package com.qingyu.mo.mybatisplus.constant;
...
public interface ConstantPlus extends Constants {
    ...
    String ADD = SPACE + PLUS + SPACE;

    String SUB = SPACE + DASH + SPACE;
    ...
    String JSON_KEY_EQ = SINGLE_QUOTE + "$." + VARIABLE + SINGLE_QUOTE + SPACE + EQUALS + SPACE + SINGLE_QUOTE + VARIABLE + SINGLE_QUOTE;
}
